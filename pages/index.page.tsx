              ...
              <div className="mx-auto w-full max-w-7xl px-6 lg:px-8">
                ...
                <div className="mx-auto mt-20 grid max-w-lg grid-cols-4 place-items-center items-center gap-x-8 gap-y-10 sm:max-w-xl sm:grid-cols-6 sm:gap-x-10 lg:mx-0 lg:max-w-none lg:grid-cols-5">
                  ...
                  <Image
                    data-aos="fade-up"
                    className="col-span-2 max-h-16 w-36 object-contain lg:col-span-1"
                    src="/logo-framework/ant-design.svg"
                    alt="ant-design"
                    width={100}
                    height={100}
                  />
                  ...
                  <Image
                    data-aos="fade-up"
                    className="col-span-2 max-h-16 w-36 object-contain lg:col-span-1"
                    src="/logo-framework/adobe-xd.svg"
                    alt="adobe-xd"
                    width={100}
                    height={100}
                  />
            ...
            <div className="relative isolate overflow-hidden bg-white/5 ring-1 ring-white/10 px-6 pt-16 shadow-2xl rounded-3xl sm:px-16 md:pt-24 lg:flex lg:gap-x-20 lg:px-8 lg:pt-0">
              ...
              >
                ...
                <svg
                  x="50%"
                  y="-1"
                  className="overflow-visible fill-gray-50 dark:fill-transparent"
                >
                  <path
              ...
              <div className="relative m-auto mt-0 h-40 lg:mt-9 lg:h-80 flex items-center justify-center">
                <Link
                  ...
                  className="flex mr-4 transition ease-in-out hover:-translate-y-1 hover:scale-110 duration-300 text-white bg-gradient-to-b from-orange-400 via-orange-500 to-orange-600 hover:bg-gradient-to-br shadow-2xl shadow-orange-400/100 dark:shadow-xl dark:shadow-orange-700/50 font-medium rounded-full px-5 py-2.5 text-center"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    fill="none"
                ...
                <Link
                  href="tel:0993362112"
                  className="flex transition ease-in-out hover:-translate-y-1 hover:scale-110 duration-300 text-gray-500 bg-gradient-to-b from-gray-100 via-gray-200 to-gray-300 hover:bg-gradient-to-br shadow-2xl shadow-gray-400/100 dark:shadow-xl dark:shadow-gray-700/50 font-medium rounded-full px-5 py-2.5 text-center"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    fill="none"
